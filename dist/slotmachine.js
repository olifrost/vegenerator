...
var SlotMachine = function () {
  ...
  _createClass(SlotMachine, [{
    ...
    key: 'random',
    get: function get() {
      var therandomindex = 0;
      var tileslength = this.tiles.length;

      var randomNumber = function () {
          var getRandomNumber = Math.floor(Math.random() * tileslength);
          if(getRandomNumber != machine1index || getRandomNumber != machine2index || getRandomNumber != machine3index || getRandomNumber != machine4index ){
